...
const BloodPressure = ({navigation}) => {
    ...
    switch (reportType) {
      case 'hour':
        return {
          ...
          datasets: [
            {
              data: [120/78,117/77,128/79,120/80,114/79,119/80],
              strokeWidth: 2,
            },
          ],
        };
      case 'daily':
        return {
          ...
          datasets: [
            {
              data: [110/78,117/77,108/79,120/80,114/79,119/80],
              strokeWidth: 2,
            },
          ],
        };
      case 'weekly':
        return {
          ...
          datasets: [
            {
              data: [110/78,117/77,108/79,120/80,114/79,119/80,117/75],
              strokeWidth: 2,
            },
          ],
        };
      case 'monthly':
        return {
          ...
          datasets: [
            {
              data: [114/78,116/79,115/80,117/77],
              strokeWidth: 2,
            },
          ],
        };
  ...
  return (
    <View style={{flex: 1, backgroundColor: 'black'}}>
      <Header title="Blood Pressure" icon={require('../src/images/plus.png')} navigation={navigation}/>
      <DateandReport />
